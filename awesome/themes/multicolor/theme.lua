...
theme.bg_urgent                                 = "#f10000"
theme.bg_minimize   = "#000000"

theme.fg_normal                                 = "#ffffff"
theme.fg_focus                                  = "#ff8c00"
theme.fg_urgent                                 = "#ff8c00"
...
theme.wallpaper     = function(s)
    ...
    elseif (i == 2) then
        ...
        return os.getenv("HOME") .. "/Pictures/wallpaper2.jpg"
    end
end
--end
...
local mytextclock = wibox.widget.textclock(markup("#7788af", "%A %m/%d ") .. markup("#ab7367", ">") .. markup("#de5e1e", " %H:%M "))
mytextclock.font = theme.font

-- Calendar
theme.cal = lain.widget.calendar({
    cal = "/usr/bin/env LANG=C /usr/bin/cal --color=always",
...
theme.weather = lain.widget.weather({
    city_id = 1791247,
    notification_preset = { font = theme.widget_font, fg = theme.fg_normal },
...
local bat = lain.widget.bat({
    settings = function()
        ...
        if bat_now.ac_status == 1 and bat_now.perc == 100 then
            perc = "fully charged"
