...
local city          = os.getenv("AWW_WEATHER_CITY") or "Wuhan,CN"
local open_map_key  = os.getenv("AWW_WEATHER_API_KEY") or 'f2942ad47bd295c96adf099bc64bdf2a'
local path_to_icons = "/usr/share/icons/Papirus/symbolic/status/"
